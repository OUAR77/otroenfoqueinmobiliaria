...
prices = [
    ("Desarrollo web completo (frontend + backend personalizado)", ""),
...
# Fila TOTAL original tachado
pdf.set_font("Arial", "B", 10)
pdf.set_text_color(51, 51, 51)
y_before = pdf.get_y()
pdf.cell(130, 7, "TOTAL (desarrollo completo, pago único)")
pdf.set_font("Arial", "B", 12)
pdf.set_text_color(180, 180, 180)
pdf.cell(0, 7, "1.500 EUR", align="R")
# Tachar el 1.500 EUR
x_right = pdf.get_x()
y_mid = y_before + 3.5
pdf.set_draw_color(220, 38, 38)
pdf.set_line_width(0.5)
pdf.line(145, y_mid, 200, y_mid)
pdf.ln(10)
...
pdf.set_text_color(220, 38, 38)
y_before2 = pdf.get_y()
pdf.cell(130, 10, "PRECIO DE AMIGO")
pdf.set_font("Arial", "B", 18)
pdf.cell(0, 10, "600 EUR", align="R")
pdf.ln(14)

# Nota
pdf.set_font("Arial", "I", 9)
pdf.set_text_color(100, 100, 100)
pdf.multi_cell(0, 5, "* Precio especial para amigos y conocidos. Válido para esta versión del proyecto.")
...
out = "C:\\Users\\DaniR\\Projects\\otroenfoqueinmobiliaria\\Memoria_Web_OtroEnfoque_Amigo.pdf"
pdf.output(out)
